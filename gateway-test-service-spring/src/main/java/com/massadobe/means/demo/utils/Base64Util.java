...
public class Base64Util {
    ...
    public static String encode(String str) {
        try {
            ...
            logger.error(Strings.lenientFormat("【BASE64-UTIL】：ENCODE %s", e.getMessage()));
    ...
    public static String decode(String str) {
        try {
            ...
            logger.error(Strings.lenientFormat("【BASE64-UTIL】：DECODE %s", e.getMessage()));
            throw new AttemptException(ErrorCodeMsg.SERVER_ERROR);
        }
    }
    ...
    public static String encrypt(String data, String key) {
        try {
            ...
            logger.error(Strings.lenientFormat("【BASE64-UTIL】：ENCRYPT %s", e.getMessage()));
    ...
    public static String decrypt(String data, String key) {
        ...
        try {
            ...
            logger.error(Strings.lenientFormat("【BASE64-UTIL】：DECRYPT %s", e.getMessage()));
